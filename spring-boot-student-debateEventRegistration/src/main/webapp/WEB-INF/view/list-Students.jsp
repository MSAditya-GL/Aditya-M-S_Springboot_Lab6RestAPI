...
<body>
	...
	<div class="container">
		...
		<form action="/studentDebateEventRegistration/student/search"
			class="form-inline">

			<!-- Add a button -->
			<a href="/studentDebateEventRegistration/student/showFormForAdd"
			...
			<a href="/studentDebateEventRegistration/logout"
				...
				<c:forEach items="${Students}" var="tempStudent">
					<tr>
						...
						<td>
							...
							href="/studentDebateEventRegistration/student/showFormForUpdate?studentId=${tempStudent.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a
							href="/studentDebateEventRegistration/student/delete?studentId=${tempStudent.id}"
		...
		<!-- Add a button -->
		<a href="/studentDebateEventRegistration/student/print"
			target="_blank" />
